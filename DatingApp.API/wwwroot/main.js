...
/***/ "./src/app/LoadingProcess/LoadingProcess.component.css":
/*!*************************************************************!*\
  !*** ./src/app/LoadingProcess/LoadingProcess.component.css ***!
  \*************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL0xvYWRpbmdQcm9jZXNzL0xvYWRpbmdQcm9jZXNzLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/LoadingProcess/LoadingProcess.component.html":
/*!**************************************************************!*\
  !*** ./src/app/LoadingProcess/LoadingProcess.component.html ***!
  \**************************************************************/
/*! no static exports found */
...
module.exports = "<img src=\"../src/assets/LoadingLine.gif\" />\n"

/***/ }),

/***/ "./src/app/LoadingProcess/LoadingProcess.component.ts":
/*!************************************************************!*\
  !*** ./src/app/LoadingProcess/LoadingProcess.component.ts ***!
  \************************************************************/
/*! exports provided: LoadingProcessComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoadingProcessComponent", function() { return LoadingProcessComponent; });
...
var LoadingProcessComponent = /** @class */ (function () {
    function LoadingProcessComponent() {
    }
    LoadingProcessComponent.prototype.ngOnInit = function () {
    };
    LoadingProcessComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-LoadingProcess',
            template: __webpack_require__(/*! ./LoadingProcess.component.html */ "./src/app/LoadingProcess/LoadingProcess.component.html"),
            styles: [__webpack_require__(/*! ./LoadingProcess.component.css */ "./src/app/LoadingProcess/LoadingProcess.component.css")]
        }),
...
var ListsResolver = /** @class */ (function () {
    ...
    ListsResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.userService.getUsers(this.pageNumber, this.pageSize, null, this.likesParam).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["catchError"])(function (error) {
    ...
    ListsResolver = __decorate([
        ...
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"],
            _angular_Router__WEBPACK_IMPORTED_MODULE_4__["Router"], _services_Alertify_service__WEBPACK_IMPORTED_MODULE_5__["AlertifyService"]])
    ], ListsResolver);
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        ...
        this.photoUrl = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]('../../assets/user section 11.png');
...
var ErrorInterceptor = /** @class */ (function () {
    ...
    ErrorInterceptor.prototype.intercept = function (req, next) {
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpErrorResponse"]) { // error coming from API
...
module.exports = "<!-- The content below is only a placeholder and can be replaced. -->\n<app-nav></app-nav>\n<router-outlet></router-outlet>\n<div *ngIf=\"showLoadingProcess\" class=\"spinner\">\n  <app-LoadingProcess></app-LoadingProcess>\n</div>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(authService, _router) {
        ...
        this._router.events.subscribe(function (routerEvent) {
            ...
            if (routerEvent instanceof _angular_Router__WEBPACK_IMPORTED_MODULE_0__["NavigationEnd"]
                ...
                _this.showLoadingProcess = false;
            }
        });
    }
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _angular_Router__WEBPACK_IMPORTED_MODULE_0__["Router"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _resolvers_lists_resolver__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./_resolvers/lists.resolver */ "./src/app/_resolvers/lists.resolver.ts");
...
/* harmony import */ var _LoadingProcess_LoadingProcess_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./LoadingProcess/LoadingProcess.component */ "./src/app/LoadingProcess/LoadingProcess.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _LoadingProcess_LoadingProcess_component__WEBPACK_IMPORTED_MODULE_32__["LoadingProcessComponent"],
            ...
            imports: [
                ...
                _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_6__["JwtModule"].forRoot({
                    // it will automatically send token to logged in user
                    config: {
            ...
            providers: [
                ...
                _resolvers_lists_resolver__WEBPACK_IMPORTED_MODULE_27__["ListsResolver"],
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.registerToggel = function () {
...
module.exports = ".card:hover img {\r\n    -webkit-transform: scale(1.2, 1.2);\r\n            transform: scale(1.2, 1.2);\r\n    transition-duration: 500ms;\r\n    transition-timing-function: ease-out;\r\n    opacity: 0.7;\r\n    cursor: pointer;\r\n}\r\n.card img {\r\n    -webkit-transform: scale(1.0, 1.0);\r\n            transform: scale(1.0, 1.0);\r\n    transition-duration: 500ms;\r\n    transition-timing-function: ease-out;\r\n}\r\n.card-img-wrapper {\r\n    overflow: hidden;\r\n    position: relative;\r\n}\r\n.member-icons {\r\n    position: absolute;\r\n    bottom: -30%;\r\n    left: 0;    \r\n    right: 0;\r\n    margin-right: auto;\r\n    margin-left: auto;\r\n    opacity: 0;\r\n}\r\n.card-img-wrapper:hover .member-icons {\r\n    bottom: 0;\r\n    opacity: 1;\r\n}\r\n.animate {\r\ntransition: all 0.3s ease-in-out;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".img-thumbnail {\r\n    margin: 25px;\r\n    width: 85%;\r\n    height: 85%;\r\n}\r\n.card-body{\r\n    padding: 0 25px;\r\n}\r\n.card-footer {\r\n    padding: 10px 15px;\r\n    background-color: #fff;\r\n    border: 1px solid rgba(0,0,0,.125);\r\n    border-top: none; \r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MemberDetailComponent = /** @class */ (function () {
    ...
    MemberDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        // this.loadUser(); // we made resolver for this so we do not need to use
        this.route.data.subscribe(function (data) {
...
module.exports = ".img-thumbnail {\r\n    margin: 25px;\r\n    width: 85%;\r\n    height: 85%;\r\n}\r\n.card-body{\r\n    padding: 0 25px;\r\n}\r\n.card-footer {\r\n    padding: 10px 15px;\r\n    background-color: #fff;\r\n    border: 1px solid rgba(0,0,0,.125);\r\n    border-top: none; \r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "img.img-thumbnail {\r\n    height: 100px;\r\n    min-width: 100px !important;\r\n    margin-bottom: 2px;\r\n}\r\n.nv-file-over {\r\n    border: dotted 3px red;\r\n}\r\ninput[type=file] {\r\n    color: transparent;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PhotoEditorComponent = /** @class */ (function () {
    ...
    PhotoEditorComponent.prototype.deletePhoto = function (id) {
        var _this = this;
        this.alertify.confirm('Are you sure do you want to delete?', function () {
            _this.showLoadingProcess = true;
            _this.userService
                ...
                _this.showLoadingProcess = false;
                _this.alertify.success('Deleted');
            }, function (error) {
                _this.alertify.error(error);
            });
        });
...
module.exports = ".dropdown-toggle, .dropdown-item {\r\n    cursor: pointer;\r\n}\r\nimg {\r\n    max-height: 50px;\r\n    border: 2px solid white;\r\n    display: inline;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var NavComponent = /** @class */ (function () {
    function NavComponent(authService, alertify, router) {
        ...
        this.alertify = alertify;
        this.router = router;
        this.model = {}; // #loginForm="ngForm" is template reference variable
    }
    ...
    NavComponent.prototype.login = function () {
        ...
        this.authService.login(this.model).subscribe(function (next) {
            ...
            _this.router.navigate(['/members']); // after login it will redirect to member list page
        });
    };
...
var RegisterComponent = /** @class */ (function () {
    ...
    function RegisterComponent(authService, router, alertify, fb) {
        ...
        this.alertify = alertify;
        this.fb = fb;
        this.cancelRegister = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"](); // @Output() conatin emitter evemt, for this use ()  to access value inside html
    }
    ...
    RegisterComponent.prototype.passwordMatch = function (g) {
...
/* harmony import */ var _resolvers_lists_resolver__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_resolvers/lists.resolver */ "./src/app/_resolvers/lists.resolver.ts");
/* harmony import */ var _guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_guards/prevent-unsaved-changes.guard */ "./src/app/_guards/prevent-unsaved-changes.guard.ts");
/* harmony import */ var _resolvers_member_edit_resolver__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_resolvers/member-edit.resolver */ "./src/app/_resolvers/member-edit.resolver.ts");
/* harmony import */ var _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_resolvers/member-detail.resolver */ "./src/app/_resolvers/member-detail.resolver.ts");
...
/* harmony import */ var _members_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./members/member-detail/member-detail.component */ "./src/app/members/member-detail/member-detail.component.ts");
...
var appRoutes = [
    ...
    { path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_6__["HomeComponent"] },
    {
        ...
        children: [
            ...
            { path: 'members/:id', component: _members_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_9__["MemberDetailComponent"],
                resolve: { user: _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_3__["MemberDetailResolver"] } },
            { path: 'member/edit', component: _members_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_11__["MemberEditComponent"],
                resolve: { user: _resolvers_member_edit_resolver__WEBPACK_IMPORTED_MODULE_2__["MemberEditResolver"] }, canDeactivate: [_guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_1__["PreventUnsavedChanges"]] },
            ...
            { path: 'lists', component: _lists_lists_component__WEBPACK_IMPORTED_MODULE_5__["ListsComponent"],
                resolve: { users: _resolvers_lists_resolver__WEBPACK_IMPORTED_MODULE_0__["ListsResolver"] } },
        ]
    },
...
module.exports = __webpack_require__(/*! D:\ASP.NET CORE\Project\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
